...
=> Todos los datos persisten una vez el usuario cierra la aplicación ya que son almacenados en un archivo
binario.
=> También hay otro archivo binario con los datos de los usuarios que se registran en la aplicación para
que puedan acceder de nuevo en cualquier momento sin tener que volverse a registrar.
...
=> Programa principal:
	...
	=> Eliminar datos.
	=> Guardar datos.
	=> Estadísticas (total de juegos y porcentaje de juegos superados).
